...
public class EficienciaAlgoritmos {
    ...
    public static void main(String[] args) {
        ...
        int idxBinaria = Busquedas.busquedaBinariaEficiente(Arrays.copyOf(datos, datos.length), objetivo);
        System.out.println("Búsqueda binaria eficiente: índice = " + idxBinaria);

        int n = 10;
        System.out.println("Fibonacci exponencial (" + n + "): " + Fibonacci.fibExponencial(n));
        System.out.println("Fibonacci memoization (" + n + "): " + Fibonacci.fibMemoization(n));
        System.out.println("Fibonacci iterativo (" + n + "): " + Fibonacci.fibIterativo(n));
